...
const loginProviderTunnistamoProperties: LoginProviderProps = {
  userManagerSettings: {
    authority:
      import.meta.env.VITE_OPENID_CONNECT_AUTHORITY_URL ||
      'https://api.hel.fi/sso/openid/',
    client_id: import.meta.env.VITE_OPENID_CONNECT_CLIENT_ID || '',
    scope:
      import.meta.env.VITE_OPENID_CONNECT_SCOPE ||
      'openid profile https://api.hel.fi/auth/mvj',
    redirect_uri: `${location.origin}/callback`,
  },
  apiTokensClientSettings: {
    url: import.meta.env.VITE_OPENID_CONNECT_API_TOKEN_URL,
  },
...
export const oidcProviderName: OidcProviderName =
  import.meta.env.VITE_OIDC_PROVIDER || 'tunnistus';
// By default use Tunnistus SSO
export const loginProviderProperties =
  oidcProviderName === 'tunnistamo'
    ? loginProviderTunnistamoProperties
    : loginProviderTunnistusProperties;
const tunnistamoApiTokenKeyName: string =
  import.meta.env.VITE_OPENID_CONNECT_API_TOKEN_KEY ||
  'https://api.hel.fi/auth/mvj';
const tunnistusApiTokenKeyName: string =
  import.meta.env.VITE_TUNNISTUS_OIDC_API_AUDIENCE || 'mvj-api';
export const apiTokenKeyName =
  oidcProviderName === 'tunnistamo'
